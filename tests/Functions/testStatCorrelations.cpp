...
std::vector<AutoCase> make_autocov_cases() {
    return {
        {{}, 0, NaN()},
        {{1}, 0, NaN()},
        {{1,2,3}, 0, 2.0/3.0},      // дисперсия
        {{1,2,3}, 1, 1.0/3.0},      // вручную
        {{1,2,3,4}, 2, 0.0}         // вручную
    };
}
...
std::vector<CrossCase> make_cross_cases() {
    return {
        {{1,2,3}, {3,2,1}, 0, -1.0/3.0}, // проверка сдвига=0
        {{1,2,3}, {3,2,1}, 1, -1.0/2.0}, // проверка сдвига=1
        {{1,2,3}, {1,2,3}, -1, 1.0/2.0}  // проверка отрицательного лага
    };
}
